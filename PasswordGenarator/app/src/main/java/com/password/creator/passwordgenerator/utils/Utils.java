package com.password.creator.passwordgenerator.utils;
...
public class Utils {
    ...
    /**
     * check list permission has granted
     *
     * @param permissionArray
     * @return
     */
    public static int checkPermission(String[] permissionArray, Context context) {

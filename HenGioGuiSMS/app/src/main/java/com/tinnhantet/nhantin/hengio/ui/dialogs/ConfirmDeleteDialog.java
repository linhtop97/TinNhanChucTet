...
import com.tinnhantet.nhantin.hengio.databinding.DialogCfDeleteBinding;
...
public class ConfirmDeleteDialog extends DialogFragment implements View.OnClickListener {
    private DialogCfDeleteBinding mBinding;
    private ViewMsgActivity mViewMsgActivity;

    public static ConfirmDeleteDialog getInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.dialog_cf_delete, container, false);
        initUI();
    ...
    public void onAttach(Context context) {
        ...
        mViewMsgActivity = (ViewMsgActivity) context;
    }
}
